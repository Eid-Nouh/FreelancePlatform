...
from .models import FreelancerProfile, Skill, Experience, Education, Portfolio
...
def profile_view(request, username=None):
    ...
    # Only freelancer profiles are allowed
    if user.user_type != 'freelancer':
        # If user is not a freelancer, redirect to home or show error
        messages.error(request, 'Only freelancer profiles are available.')
...
def edit_profile_view(request):
    ...
    if user.user_type != 'freelancer':
        messages.error(request, 'Only freelancers can edit profiles.')
